...
- [x] 쿠폰 사용 모델 설계 (`user_coupons` 발급 테이블 + `isPublic` 공개/비공개 구분)
- [x] `GET /api/coupons/my` — 내가 사용할 수 있는 쿠폰 목록 (USER 권한)
- [x] `POST /api/coupons/claim` — 공개 쿠폰 코드 입력으로 지갑 등록 (USER 권한)
